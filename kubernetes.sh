...
CLUSTERCTL_VERSION=${CLUSTERCTL_VERSION:-v1.13.4}
...
CILIUM_VERSION=${CILIUM_VERSION:-v0.19.6}
...
log "Installing flux..."
FLUX_VERSION=${FLUX_VERSION:-2.9.2}
...
VCLUSTER_VERSION=${VCLUSTER_VERSION:-v0.36.0}
